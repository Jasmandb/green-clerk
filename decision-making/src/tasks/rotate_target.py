...
if __name__ == '__main__':
    ...
    if test == '1':
        ...
        time.sleep(2)
        rotate_target1.roll_back(Classification.GARBAGE)
    elif test == '2':
        logger.debug(
        ...
        time.sleep(2)
        rotate_target2.roll_back(Classification.PAPER)
    elif test == '3':
        logger.debug(
        ...
        time.sleep(2)
        rotate_target3.roll_back(Classification.GLASS)
    elif test == '4':
        logger.debug(
        ...
        time.sleep(2)
        rotate_target4.roll_back(Classification.RECYCLABLES)
